...
public class And extends Wyr2ArgLogiczne {
    @JsonCreator
    public And(@JsonProperty("argument1") Instrukcja argument1,
    ...
    public double wykonaj() throws BladWykonania {
        if (!this.argument1.jestWyrazeniem() && !this.argument2.jestWyrazeniem()) {
            throw new BladWykonania("Błąd wykonania: argumenty operacji " +
                                    "logicznej And nie są wyrażeniami logicznymi lub arytmetycznymi.\n");
        } else if (!this.argument1.jestWyrazeniem()) {
            throw new BladWykonania("Błąd wykonania: pierwszy argument operacji " +
                                    "logicznej And nie jest wyrażeniem logicznym lub arytmetycznym.\n");
